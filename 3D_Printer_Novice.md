...
&emsp;&emsp;此教程并非仅针对拓竹3D打印机设备进行讲解，Bambu Studio切片软件使用过程同样适用于其他切片软件，只在一些特殊技术设置上存在差别。
...
<div align=center>
    <img src="./Assets/多色打印.png" alt="多色打印" width=60%>
</div>
...
<div align=center>
    <img src="./Assets/打印界面.png" alt="打印界面" width=60%>
</div>
